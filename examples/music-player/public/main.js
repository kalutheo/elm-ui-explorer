...
var author$project$Ports$playNext = _Platform_incomingPort(
	'playNext',
...
var author$project$Model$mockAlbum = {
	cover: 'https://i.scdn.co/image/d025af49bb84dbb26393f42ff9646f1c748c3035',
	playlist: _List_fromArray(
		[
			{duration: 322213, name: 'Viens voir le docteur - Dirty moog mix', url: 'https://p.scdn.co/mp3-preview/fb897f080a9c6765cc9178d48abcb4d6f81b472c'},
			{duration: 338840, name: 'Nirvana', url: 'https://p.scdn.co/mp3-preview/887d0e4b4aa31b5c4ed971394dbc21573aaa4e8c'},
			{duration: 274080, name: 'Né ici', url: 'https://p.scdn.co/mp3-preview/2aac3d146c048482bea5493a0d7b44ccc4749b65'}
		]),
	title: 'Menu Best Of'
};
var author$project$Model$model = {album: author$project$Model$mockAlbum, isPlaying: false, selectedTrack: elm$core$Maybe$Nothing};
...
var author$project$Ports$load = _Platform_outgoingPort(
	'load',
	function ($) {
...
var author$project$Update$init = function (_n0) {
	var firstTrack = A2(
		elm$core$Array$get,
		0,
		elm$core$Array$fromList(author$project$Model$model.album.playlist));
	if (firstTrack.$ === 'Nothing') {
		return _Utils_Tuple2(author$project$Model$model, elm$core$Platform$Cmd$none);
	} else {
		var track = firstTrack.a;
		return _Utils_Tuple2(
			_Utils_update(
				author$project$Model$model,
				{
					selectedTrack: elm$core$Maybe$Just(track)
				}),
			author$project$Ports$load(track));
	}
};
var author$project$Msg$SelectTrack = function (a) {
	return {$: 'SelectTrack', a: a};
};
var author$project$Ports$loadAndPlay = _Platform_outgoingPort(
	'loadAndPlay',
	function ($) {
		return elm$json$Json$Encode$object(
			_List_fromArray(
...
var author$project$Utils$findIndex = F2(
	function (pred, arr) {
		var findIndexStartingAt = function (i) {
			return A2(
				elm$core$Maybe$andThen,
				function (elem) {
					return pred(elem) ? elm$core$Maybe$Just(i) : findIndexStartingAt(i + 1);
				},
				A2(elm$core$Array$get, i, arr));
		};
		return findIndexStartingAt(0);
	});
var author$project$Utils$getCurrentTrackIndex = F2(
	function (selectedTrack, playlist) {
		return A2(
			author$project$Utils$findIndex,
			function (t) {
				if (selectedTrack.$ === 'Nothing') {
					return false;
				} else {
					var track = selectedTrack.a;
					return _Utils_eq(t, track);
				}
			},
			elm$core$Array$fromList(playlist));
	});
var author$project$Utils$oneOf = function (maybes) {
	oneOf:
	while (true) {
		if (!maybes.b) {
			return elm$core$Maybe$Nothing;
...
var author$project$Utils$nextTrack = F2(
	function (selectedTrack, playlist) {
		var albums = elm$core$Array$fromList(playlist);
		var _n0 = A2(author$project$Utils$getCurrentTrackIndex, selectedTrack, playlist);
		if (_n0.$ === 'Nothing') {
			return elm$core$Maybe$Nothing;
		} else {
			var index = _n0.a;
			return author$project$Utils$oneOf(
				_List_fromArray(
					[
						A2(elm$core$Array$get, index + 1, albums),
						A2(elm$core$Array$get, 0, albums)
					]));
		}
	});
var author$project$Utils$previousTrack = F2(
	function (selectedTrack, playlist) {
		var albums = elm$core$Array$fromList(playlist);
		var _n0 = A2(author$project$Utils$getCurrentTrackIndex, selectedTrack, playlist);
		if (_n0.$ === 'Nothing') {
			...
			return author$project$Utils$oneOf(
				_List_fromArray(
					[
						...
						A2(
						elm$core$Array$get,
						elm$core$List$length(playlist) - 1,
						albums)
					]));
		}
	});
			...
			switch (msg.$) {
				case 'SelectTrack':
					...
					return _Utils_Tuple2(
						...
						author$project$Ports$loadAndPlay(track));
				case 'Play':
					return _Utils_Tuple2(
						_Utils_update(
							model,
				...
				case 'Next':
					var _n1 = A2(author$project$Utils$nextTrack, model.selectedTrack, model.album.playlist);
					if (_n1.$ === 'Nothing') {
						return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
					} else {
						var track = _n1.a;
						var $temp$msg = author$project$Msg$SelectTrack(track),
							$temp$model = model;
						msg = $temp$msg;
						model = $temp$model;
						continue update;
				...
				default:
					var _n2 = A2(author$project$Utils$previousTrack, model.selectedTrack, model.album.playlist);
					if (_n2.$ === 'Nothing') {
						return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
					} else {
						var track = _n2.a;
...
var author$project$Style$System$neutral = {black: '#FFFFFF', white: '#FFFFFF'};
var author$project$Style$Utils$HexaColor = function (a) {
	return {$: 'HexaColor', a: a};
};
...
var author$project$Style$Utils$rec = F2(
					...
					_List_fromArray(
						[
							...
							A2(
								elm$core$String$join,
								'',
								A2(elm$core$List$take, 2, incoming)))
						])),
					$temp$incoming = A2(elm$core$List$drop, 2, incoming);
				result = $temp$result;
...
var author$project$Style$Utils$hexToRgb = function (_n0) {
	var color = _n0.a;
	var colorsList = A2(
		elm$core$List$map,
		function (a) {
			...
			A2(
				...
				function (n) {
					return A2(
						...
						A2(author$project$Style$Utils$rec, _List_Nil, n));
				},
				elm$core$List$tail(
					A2(elm$core$String$split, '', color)))));
	var newColor = function () {
		if (((colorsList.b && colorsList.b.b) && colorsList.b.b.b) && (!colorsList.b.b.b.b)) {
			var r = colorsList.a;
			var _n2 = colorsList.b;
			var g = _n2.a;
			var _n3 = _n2.b;
			var b = _n3.a;
			return A4(mdgriffith$elm_ui$Element$rgba255, r, g, b, 1);
		} else {
			return A4(mdgriffith$elm_ui$Element$rgba255, 0, 0, 0, 1);
		}
	}();
	return newColor;
};
...
var author$project$Style$Utils$bgColor = function (color) {
	return mdgriffith$elm_ui$Element$Background$color(
		author$project$Style$Utils$hexToRgb(
			author$project$Style$Utils$HexaColor(color)));
};
...
var author$project$View$viewControlButton = F2(
	function (icon, clickMessage) {
		return A2(
			...
			_List_fromArray(
				[
					...
					mdgriffith$elm_ui$Element$Events$onClick(clickMessage)
				]),
			mdgriffith$elm_ui$Element$html(
				A2(
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('fa fa-fw ' + icon),
...
var author$project$View$viewNextButton = A2(author$project$View$viewControlButton, 'fa-fast-forward', author$project$Msg$Next);
var author$project$Msg$Pause = {$: 'Pause'};
var author$project$Msg$Play = {$: 'Play'};
var author$project$View$viewPlayButton = function (isPlaying) {
	var props = isPlaying ? _Utils_Tuple2(author$project$Msg$Pause, 'fa-pause') : _Utils_Tuple2(author$project$Msg$Play, 'fa-play');
	return A2(author$project$View$viewControlButton, props.b, props.a);
};
var author$project$Msg$Previous = {$: 'Previous'};
var author$project$View$viewPrevButton = A2(author$project$View$viewControlButton, 'fa-fast-backward', author$project$Msg$Previous);
...
var author$project$View$viewPlayerControls = function (isPlaying) {
	return A2(
		...
		_List_fromArray(
			[
				author$project$View$viewPrevButton,
				author$project$View$viewPlayButton(isPlaying),
				author$project$View$viewNextButton
			]));
};
...
var author$project$View$viewAlbumPreview = function (previewModel) {
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$padding(0),
				mdgriffith$elm_ui$Element$Background$uncropped(previewModel.cover),
				mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
				mdgriffith$elm_ui$Element$height(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$Background$color(
								A4(mdgriffith$elm_ui$Element$rgba255, 41, 23, 32, 0.8))
							])),
						mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
						mdgriffith$elm_ui$Element$height(mdgriffith$elm_ui$Element$fill)
					]),
				author$project$View$viewPlayerControls(previewModel.isPlaying))
			]));
};
...
var author$project$Style$System$font = {
...
var author$project$Style$System$pink = {base: '#F66D9B', dark: '#EB5286', darker: '#6F213F', darkest: '#451225', light: '#FA7EA8', lighter: '#FFBBCA', lightest: '#FFEBEF'};
...
var author$project$Style$Utils$textColor = function (color) {
...
var author$project$View$viewHeader = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				author$project$Style$Utils$bgColor(author$project$Style$System$pink.darkest),
				mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
				mdgriffith$elm_ui$Element$height(
				mdgriffith$elm_ui$Element$px(60)),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$Font$family(author$project$Style$System$font.primary),
						mdgriffith$elm_ui$Element$Font$size(16),
						author$project$Style$Utils$textColor(author$project$Style$System$neutral.white),
						mdgriffith$elm_ui$Element$centerX,
						mdgriffith$elm_ui$Element$centerY
					]),
				mdgriffith$elm_ui$Element$text(model.album.title))
			]));
};
...
var author$project$View$viewPlayer = function (model) {
	var previewModel = {cover: model.album.cover, isPlaying: model.isPlaying};
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Element$px(280)),
				author$project$Style$Utils$bgColor(author$project$Style$System$neutral.white),
		...
		_List_fromArray(
			[
				...
				author$project$View$viewAlbumPreview(previewModel)
			]));
};
...
var author$project$View$view = function (model) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					author$project$View$viewPlayer(model)
				])));
};
...
var author$project$Main$main = elm$browser$Browser$element(
	{
		...
		subscriptions: elm$core$Basics$always(
			author$project$Ports$playNext(
				function (_n0) {
					return author$project$Msg$Next;
				})),
		update: author$project$Update$update,
		view: author$project$View$view
	});
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Msg.Msg","aliases":{"Model.Track":{"args":[],"type":"{ url : String.String, name : String.String, duration : Basics.Int }"}},"unions":{"Msg.Msg":{"args":[],"tags":{"Next":[],"Play":[],"Pause":[],"Previous":[],"SelectTrack":["Model.Track"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));