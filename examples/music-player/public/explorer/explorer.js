...
var author$project$Stories$AlbumPreview$stories = _List_fromArray(
	[
		_Utils_Tuple2(
		'Cover1',
		{cover: 'https://i.scdn.co/image/2858d626c9e2289b2477b9ce39651252fd0f3ecf', isPlaying: false}),
		_Utils_Tuple2(
		'Cover2',
		{cover: 'https://i.scdn.co/image/fe1695269d040873e8bbeab94c865ceaac4891f4', isPlaying: false})
	]);
...
var mdgriffith$elm_ui$Element$layout = mdgriffith$elm_ui$Element$layoutWith(
	{options: _List_Nil});
var author$project$Stories$Utils$withElmUi = F2(
	function (view, model) {
		return A2(
...
var author$project$Stories$AlbumPreview$viewStories = A2(
	author$project$UIExplorer$renderStories,
	author$project$Stories$Utils$withElmUi(author$project$View$viewAlbumPreview),
	author$project$Stories$AlbumPreview$stories);
...
var author$project$UIExplorer$createUIWithDescription = F3(
	function (id, description, viewStories) {
		return author$project$UIExplorer$UIType(
			{description: description, id: id, viewStories: viewStories});
	});
var author$project$UIExplorer$createUI = F2(
	function (id, viewStories) {
		return A3(author$project$UIExplorer$createUIWithDescription, id, '', viewStories);
	});
...
var author$project$Explorer$main = author$project$UIExplorer$app(
	author$project$UIExplorer$fromUIList(
		_List_fromArray(
			[
				A2(author$project$UIExplorer$createUI, 'AlbumPreview', author$project$Stories$AlbumPreview$viewStories)
			])));
