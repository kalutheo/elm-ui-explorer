module Content.Component.Button exposing (note, storySourceCode, sourceCode)


sourceCode = "<button class='button'>Hello world</button>"
...
"""
module RawContent exposing (note, storySourceCode, sourceCode)
