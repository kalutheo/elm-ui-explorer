...
var $jfmengels$elm_review$Review$Project$Project = function (a) {
	return {$: 'Project', a: a};
};
var $jfmengels$elm_review$Review$Project$new = $jfmengels$elm_review$Review$Project$Project(
	{elmJson: $elm$core$Maybe$Nothing});
var $jfmengels$elm_review$Review$Error = function (a) {
	return {$: 'Error', a: a};
};
var $jfmengels$elm_review$Review$compareRange = F2(
	function (a, b) {
...
var $jfmengels$elm_review$Review$compareErrorPositions = F2(
	function (_v0, _v1) {
		var a = _v0.a;
		var b = _v1.a;
		return A2($jfmengels$elm_review$Review$compareRange, a.range, b.range);
	});
...
var $jfmengels$elm_review$Review$parseSource = function (source) {
	return A2(
		$elm$core$Result$map,
...
var $jfmengels$elm_review$Review$Rule$analyzer = function (_v0) {
	var rule = _v0.a;
	return rule.analyzer;
};
var $jfmengels$elm_review$Review$Util$moduleName = function (moduleName_) {
	return A2(
		$elm$core$String$join,
		'.',
		$stil4m$elm_syntax$Elm$Syntax$Node$value(moduleName_));
};
var $jfmengels$elm_review$Review$moduleName = function (file) {
	var moduleNameNode = function () {
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(file.moduleDefinition);
		switch (_v0.$) {
			case 'NormalModule':
				var data = _v0.a;
	...
	return $jfmengels$elm_review$Review$Util$moduleName(moduleNameNode);
};
...
var $jfmengels$elm_review$Review$Rule$name = function (_v0) {
	var rule = _v0.a;
	return rule.name;
};
var $jfmengels$elm_review$Review$ruleErrorToReviewError = F3(
	function (moduleName_, rule, error) {
		return $jfmengels$elm_review$Review$Error(
			{
				details: $jfmengels$elm_review$Review$Rule$errorDetails(error),
				fixes: $jfmengels$elm_review$Review$Rule$errorFixes(error),
				message: $jfmengels$elm_review$Review$Rule$errorMessage(error),
				moduleName: $elm$core$Maybe$Just(moduleName_),
				range: $jfmengels$elm_review$Review$Rule$errorRange(error),
				ruleName: $jfmengels$elm_review$Review$Rule$name(rule)
			});
	});
var $jfmengels$elm_review$Review$reviewWithRule = F4(
	function (project, path, file, rule) {
		return A2(
			$elm$core$List$map,
			A2(
				$jfmengels$elm_review$Review$ruleErrorToReviewError,
				$jfmengels$elm_review$Review$moduleName(file),
				rule),
			A3($jfmengels$elm_review$Review$Rule$analyzer, rule, project, file));
	});
var $jfmengels$elm_review$Review$review = F3(
	function (config, project, _v0) {
		var path = _v0.path;
		var source = _v0.source;
		var _v1 = $jfmengels$elm_review$Review$parseSource(source);
		if (_v1.$ === 'Ok') {
			var file = _v1.a;
			return A2(
				$elm$core$List$sortWith,
				$jfmengels$elm_review$Review$compareErrorPositions,
				A2(
					$elm$core$List$concatMap,
					A3($jfmengels$elm_review$Review$reviewWithRule, project, path, file),
					config));
		} else {
			return _List_fromArray(
				[
					$jfmengels$elm_review$Review$Error(
					{
						details: _List_fromArray(
							['I could not understand the content of this file, and this prevents me from analyzing it. It is highly likely that the content of the file is not correct Elm code.', 'Hint: Try running `elm make`. The compiler should give you better hints on how to resolve the problem.']),
...
var $author$project$UIExplorer$Plugins$Review$initErrors = F2(
	function (config, sourceCode) {
		return A3(
			$jfmengels$elm_review$Review$review,
			config,
...
var $author$project$Button$decoration = function (shape) {
	switch (shape.$) {
		case 'Link':
			return _List_fromArray(
				[
...
var $author$project$Button$widthFromSize = function (size) {
	switch (size.$) {
		case 'S':
...
var $author$project$Button$styledButton = function (_v0) {
	var appearance = _v0.appearance;
	var size = _v0.size;
	var kind = _v0.kind;
	var theme = _v0.theme;
	return A2(
		...
		_Utils_ap(
			_List_fromArray(
				[
					...
					$author$project$Button$widthFromSize(size)),
...
var $jfmengels$elm_review_reporter$Reporter$Reviewing = {$: 'Reviewing'};
var $jfmengels$elm_review_reporter$Reporter$fileIdentifier = function (_v0) {
	var file = _v0.a;
	return file.path;
};
var $jfmengels$elm_review_reporter$Text$Text = function (a) {
	return {$: 'Text', a: a};
};
var $jfmengels$elm_review_reporter$Text$from = function (value) {
	return $jfmengels$elm_review_reporter$Text$Text(
		{backgroundColor: $elm$core$Maybe$Nothing, color: $elm$core$Maybe$Nothing, str: value});
};
var $jfmengels$elm_review_reporter$Text$inRed = function (_v0) {
	var text = _v0.a;
	return $jfmengels$elm_review_reporter$Text$Text(
		_Utils_update(
			text,
...
var $jfmengels$elm_review_reporter$Reporter$fileSeparator = F2(
	function (a, b) {
		var identifierAbove = $jfmengels$elm_review_reporter$Reporter$fileIdentifier(a);
		return _List_fromArray(
			[
				$jfmengels$elm_review_reporter$Text$from(
				'\n\n' + A2(
					$elm$core$String$repeat,
					73 - $elm$core$String$length(identifierAbove),
					' ')),
				$jfmengels$elm_review_reporter$Text$inRed(
				$jfmengels$elm_review_reporter$Text$from(
					($jfmengels$elm_review_reporter$Reporter$fileIdentifier(a) + '  ↑') + ('\n====o======================================================================o====' + ('\n    ↓  ' + $jfmengels$elm_review_reporter$Reporter$fileIdentifier(b))))),
				$jfmengels$elm_review_reporter$Text$from('\n\n\n')
			]);
	});
var $elm$core$String$trim = _String_trim;
var $jfmengels$elm_review_reporter$Reporter$getIndexOfFirstNonSpace = F2(
				...
				$elm$core$List$head(
					A2(
						...
						$elm$core$String$trim(
							A2($elm$core$String$dropLeft, offset, string)),
						string))));
	});
var $elm$core$String$lines = _String_lines;
var $jfmengels$elm_review_reporter$Reporter$prependWithLineNumber = F2(
	function (rowIndex, line) {
		return $elm$core$String$fromInt(rowIndex + 1) + ('| ' + line);
	});
var $jfmengels$elm_review_reporter$Reporter$getRowAtLine = function (file) {
	var lines = $elm$core$Array$fromList(
		$elm$core$String$lines(file.source));
	return function (rowIndex) {
		var _v0 = A2($elm$core$Array$get, rowIndex, lines);
		if (_v0.$ === 'Just') {
			var line = _v0.a;
			return ($elm$core$String$trim(line) !== '') ? A2($jfmengels$elm_review_reporter$Reporter$prependWithLineNumber, rowIndex, line + '\n') : '';
		} else {
			return '';
		}
	};
};
var $jfmengels$elm_review_reporter$Reporter$offsetBecauseOfLineNumber = function (lineNumber) {
	return 2 + $elm$core$String$length(
		$elm$core$String$fromInt(lineNumber));
};
var $jfmengels$elm_review_reporter$Reporter$underlineError = F2(
	function (lineNumber, _v0) {
		var start = _v0.start;
		var end = _v0.end;
		return _List_fromArray(
			[
				...
				A2(
					$elm$core$String$repeat,
					($jfmengels$elm_review_reporter$Reporter$offsetBecauseOfLineNumber(lineNumber) + start) - 1,
					' ')),
				$jfmengels$elm_review_reporter$Text$inRed(
				$jfmengels$elm_review_reporter$Text$from(
...
var $jfmengels$elm_review_reporter$Reporter$codeExtract = function (file) {
	var getRowAtLine_ = $jfmengels$elm_review_reporter$Reporter$getRowAtLine(file);
	return function (range) {
		var start = range.start;
		var end = range.end;
		if (_Utils_eq(range.start, range.end)) {
			return _List_Nil;
		} else {
			if (_Utils_eq(start.row, end.row)) {
				return $elm$core$List$concat(
					_List_fromArray(
						[
							...
							A2(
							$jfmengels$elm_review_reporter$Reporter$underlineError,
							start.row - 1,
							{end: end.column, start: start.column}),
							_List_fromArray(
							[
								$jfmengels$elm_review_reporter$Text$from(
				...
				var startLine = getRowAtLine_(start.row - 1);
				var linesBetweenStartAndEnd = A2(
					$elm$core$List$map,
					getRowAtLine_,
					A2($elm$core$List$range, start.row, end.row - 2));
				var endLine = getRowAtLine_(end.row - 1);
				return $elm$core$List$concat(
					_List_fromArray(
						[
							_List_fromArray(
							[
								$jfmengels$elm_review_reporter$Text$from(
								getRowAtLine_(start.row - 2)),
								$jfmengels$elm_review_reporter$Text$from(startLine)
							]),
							A2(
							$jfmengels$elm_review_reporter$Reporter$underlineError,
							start.row - 1,
							{
								end: $elm$core$String$length(startLine) - $jfmengels$elm_review_reporter$Reporter$offsetBecauseOfLineNumber(start.row - 1),
								start: start.column
							}),
							A2(
							$elm$core$List$concatMap,
							function (_v0) {
								...
								return A2(
									$elm$core$List$cons,
									$jfmengels$elm_review_reporter$Text$from(line),
									A2(
										$jfmengels$elm_review_reporter$Reporter$underlineError,
										lineNumber,
										{
											end: $elm$core$String$length(line) - $jfmengels$elm_review_reporter$Reporter$offsetBecauseOfLineNumber(lineNumber),
											start: A2(
												$jfmengels$elm_review_reporter$Reporter$getIndexOfFirstNonSpace,
												$jfmengels$elm_review_reporter$Reporter$offsetBecauseOfLineNumber(lineNumber),
												line)
										}));
							},
							A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, linesBetweenStartAndEnd)),
							_List_fromArray(
							[
								$jfmengels$elm_review_reporter$Text$from(endLine)
							]),
							A2(
							$jfmengels$elm_review_reporter$Reporter$underlineError,
							end.row - 1,
							{
								end: $elm$core$String$length(endLine) - $jfmengels$elm_review_reporter$Reporter$offsetBecauseOfLineNumber(end.row - 1),
								start: A2(
									$jfmengels$elm_review_reporter$Reporter$getIndexOfFirstNonSpace,
									$jfmengels$elm_review_reporter$Reporter$offsetBecauseOfLineNumber(end.row - 1),
									endLine)
							}),
							_List_fromArray(
							[
...
var $jfmengels$elm_review_reporter$Text$inBlue = function (_v0) {
	var text = _v0.a;
	return $jfmengels$elm_review_reporter$Text$Text(
		_Utils_update(
			text,
			{
				color: $elm$core$Maybe$Just(
					_Utils_Tuple3(51, 187, 200))
			}));
};
var $jfmengels$elm_review_reporter$Reporter$formatErrorWithExtract = F3(
	function (mode, file, _v0) {
		var ruleName = _v0.ruleName;
		var message = _v0.message;
		var details = _v0.details;
		var range = _v0.range;
		var hasFix = _v0.hasFix;
		var title = _List_fromArray(
			[
				$jfmengels$elm_review_reporter$Text$inRed(
				$jfmengels$elm_review_reporter$Text$from(ruleName)),
				$jfmengels$elm_review_reporter$Text$from(': ' + message)
			]);
		var details_ = A2(
			$elm$core$List$intersperse,
			$jfmengels$elm_review_reporter$Text$from('\n\n'),
			A2($elm$core$List$map, $jfmengels$elm_review_reporter$Text$from, details));
		var codeExtract_ = A2($jfmengels$elm_review_reporter$Reporter$codeExtract, file, range);
		return $elm$core$List$concat(
			A2(
				$elm$core$List$intersperse,
				_List_fromArray(
				...
				A2(
					...
					_List_fromArray(
						[
							...
							function () {
							if (mode.$ === 'Reviewing') {
								return hasFix ? _List_fromArray(
									[
										$jfmengels$elm_review_reporter$Text$from('I think I know how to fix this problem. If you run '),
										$jfmengels$elm_review_reporter$Text$inBlue(
										$jfmengels$elm_review_reporter$Text$from('elm-review --fix')),
										$jfmengels$elm_review_reporter$Text$from(', I can\nsuggest a solution and you can validate it.')
									]) : _List_Nil;
							} else {
								return _List_Nil;
							}
...
var $jfmengels$elm_review_reporter$Text$join = F2(
	function (sep, chunks) {
		return A2(
			$elm$core$List$concatMap,
			$elm$core$Basics$identity,
			A2(
				...
				_List_fromArray(
					[
						$jfmengels$elm_review_reporter$Text$from(sep)
					]),
				chunks));
	});
...
var $jfmengels$elm_review_reporter$Reporter$formatReportForFileWithExtract = F2(
	function (mode, _v0) {
		var file = _v0.a;
		var errors = _v0.b;
		var prefix = '-- ELM-REVIEW ERROR ';
		var header = $jfmengels$elm_review_reporter$Text$inBlue(
			$jfmengels$elm_review_reporter$Text$from(
				_Utils_ap(
					prefix,
					A3(
						$elm$core$String$padLeft,
						80 - $elm$core$String$length(prefix),
						_Utils_chr('-'),
						' ' + $jfmengels$elm_review_reporter$Reporter$fileIdentifier(
							_Utils_Tuple2(file, errors))))));
		var formattedErrors = A2(
			$elm$core$List$map,
			A2($jfmengels$elm_review_reporter$Reporter$formatErrorWithExtract, mode, file),
			errors);
		return A2(
			$elm$core$List$cons,
			header,
			A2(
				$elm$core$List$cons,
				$jfmengels$elm_review_reporter$Text$from('\n\n'),
				A2($jfmengels$elm_review_reporter$Text$join, '\n\n\n', formattedErrors)));
	});
var $jfmengels$elm_review_reporter$Reporter$formatReports = F2(
	function (mode, errors) {
		if (!errors.b) {
			return _List_Nil;
		} else {
			if (!errors.b.b) {
				var error = errors.a;
				return A2($jfmengels$elm_review_reporter$Reporter$formatReportForFileWithExtract, mode, error);
			} else {
				var firstError = errors.a;
				var _v1 = errors.b;
				var secondError = _v1.a;
				var restOfErrors = _v1.b;
				return $elm$core$List$concat(
					_List_fromArray(
						[
							A2($jfmengels$elm_review_reporter$Reporter$formatReportForFileWithExtract, mode, firstError),
							A2($jfmengels$elm_review_reporter$Reporter$fileSeparator, firstError, secondError),
							A2(
							$jfmengels$elm_review_reporter$Reporter$formatReports,
							mode,
							A2($elm$core$List$cons, secondError, restOfErrors))
						]));
			}
		}
	});
var $jfmengels$elm_review_reporter$Text$toRecord = function (_v0) {
	var text = _v0.a;
	return text;
};
var $jfmengels$elm_review_reporter$Reporter$totalNumberOfErrors = function (errors) {
	return $elm$core$List$length(
		A2($elm$core$List$concatMap, $elm$core$Tuple$second, errors));
};
var $jfmengels$elm_review_reporter$Reporter$formatReport = F2(
	function (mode, errors) {
		var numberOfErrors = $jfmengels$elm_review_reporter$Reporter$totalNumberOfErrors(errors);
		return (!numberOfErrors) ? $elm$core$List$singleton(
			$jfmengels$elm_review_reporter$Text$toRecord(
				$jfmengels$elm_review_reporter$Text$from('I found no problems while reviewing!\n'))) : A2(
			$elm$core$List$map,
			$jfmengels$elm_review_reporter$Text$toRecord,
			$elm$core$List$concat(
				_List_fromArray(
...
var $jfmengels$elm_review$Review$errorDetails = function (_v0) {
	var error = _v0.a;
	return error.details;
};
var $jfmengels$elm_review$Review$errorFixes = function (_v0) {
	var error = _v0.a;
	return error.fixes;
};
var $jfmengels$elm_review$Review$errorMessage = function (_v0) {
	var error = _v0.a;
	return error.message;
};
var $jfmengels$elm_review$Review$errorModuleName = function (_v0) {
	var error = _v0.a;
	return error.moduleName;
};
var $jfmengels$elm_review$Review$errorRange = function (_v0) {
	var error = _v0.a;
	return error.range;
};
var $jfmengels$elm_review$Review$errorRuleName = function (_v0) {
	var error = _v0.a;
	return error.ruleName;
};
var $author$project$UIExplorer$Plugins$Review$fromReviewError = function (error) {
	return {
		details: $jfmengels$elm_review$Review$errorDetails(error),
		hasFix: !_Utils_eq(
			$jfmengels$elm_review$Review$errorFixes(error),
			$elm$core$Maybe$Nothing),
		message: $jfmengels$elm_review$Review$errorMessage(error),
		moduleName: $jfmengels$elm_review$Review$errorModuleName(error),
		range: $jfmengels$elm_review$Review$errorRange(error),
		ruleName: $jfmengels$elm_review$Review$errorRuleName(error)
	};
};
var $author$project$UIExplorer$Plugins$Review$reviewErrors = function (options) {
	return A2(
		$jfmengels$elm_review_reporter$Reporter$formatReport,
		$jfmengels$elm_review_reporter$Reporter$Reviewing,
		_List_fromArray(
			[
				_Utils_Tuple2(
				$author$project$UIExplorer$Plugins$Review$file(options.sourceCode),
				A2($elm$core$List$map, $author$project$UIExplorer$Plugins$Review$fromReviewError, options.errors))
			]));
};
var $elm$html$Html$br = _VirtualDom_node('br');
var $author$project$UIExplorer$Plugins$Review$viewPart = function (_v0) {
	var str = _v0.str;
	var color = _v0.color;
			...
			[
				...
				if (color.$ === 'Just') {
					...
					return A2(
						$elm$html$Html$Attributes$style,
						'color',
						'rgb(' + ($elm$core$String$fromInt(red) + (',' + ($elm$core$String$fromInt(green) + (',' + ($elm$core$String$fromInt(blue) + ')'))))));
				} else {
					return $elm$html$Html$Attributes$classList(_List_Nil);
				}
			}(),
				function () {
				if (backgroundColor.$ === 'Just') {
					var _v4 = backgroundColor.a;
					var red = _v4.a;
					var green = _v4.b;
					var blue = _v4.c;
					return A2(
...
var $author$project$UIExplorer$Plugins$Review$viewReviewErrors = function (options) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		A2(
			$elm$core$List$map,
			$author$project$UIExplorer$Plugins$Review$viewPart,
			$author$project$UIExplorer$Plugins$Review$reviewErrors(options)));
};
var $author$project$UIExplorer$Plugins$Review$viewEnhancer = function (model) {
	var _v0 = $author$project$UIExplorer$getCurrentSelectedStory(model);
	if (_v0.$ === 'Just') {
		var _v1 = _v0.a;
		var option = _v1.c;
		return $author$project$UIExplorer$Plugins$Review$viewReviewErrors(option.review);
	} else {
		return $elm$html$Html$text('');
	}
};
